...
class Script(scripts.Script):
    ...
    def ui(self, is_img2img):
        ...
        pattern = r'^([\w\d_]+\.(ckpt|safetensors)),([\d.]+),([\d.]+),([\d.]+),([\d.]+),([\d.]+),([\d.]+),([\d.]+),([\d.]+),([\d.]+),([\d.]+),([\d.]+),([\d.]+),([\d.]+),([\d.]+),([\d.]+),([\d.]+),([\d.]+),([\d.]+),([\d.]+),([\d.]+),([\d.]+),([\d.]+),([\d.]+),([\d.]+),([\d.]+)$'
        match = re.match(pattern, self.compare.value)
        if match is None:
        # input is invalid
        ...
        # input is valid
            pass
        self.gpu_merge = gr.Checkbox(label="Merge using GPU", value=True, elem_id="gpu-merge")
        self.verbose = gr.Checkbox(label="Verbose", value=False, elem_id="verbose-merge")
        self.finishreload = gr.Checkbox(label="Reload checkpoint when finished", value=False, elem_id="reload-merge")
